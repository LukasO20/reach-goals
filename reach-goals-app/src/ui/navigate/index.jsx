...
const Navigate = () => {
    ...
    const isHomePage =
        layout.page.pageName === 'home' || location.pathname.slice(1) === 'home'
    const isCalendarPage =
        layout.page.pageName === 'calendar' ||
        location.pathname.slice(1) === 'calendar'
    const isObjectivesPage =
        layout.page.pageName === 'objectives' ||
        location.pathname.slice(1) === 'objectives'
    ...
    const handleClickNavigateExpand = () => {
        ...
        setUserConfigLayout({
            type: 'visibility',
            data: { navigateBar: navigateBarValue },
        })
    }
    ...
    const buttonLinkClass = cx(`${isNavigateBarExpand && 'plan-round'}`)
    ...
    return (
        <div
            className='container-navigate aside-content'
        ...
        >
            <div className={navClass}>
                <div className='item-nav'>
                    <ButtonLink
                        ...
                        switchLayout={switchLayoutMap({
                            area: 'page',
                            layout: { pageName: 'home', layoutName: 'column' },
                        })}
                ...
                <div className='item-nav'>
                    <Tooltip
                        title={navigateBarData.titleTooltip.home}
                ...
                <div className='item-nav'>
                    <Tooltip
                        title={navigateBarData.titleTooltip.calendar}
                        positions={tooltipPositions}
                    >
                        <ButtonLink
                            link='/calendar'
                ...
                <div className='item-nav'>
                    <Tooltip
                        title={navigateBarData.titleTooltip.objectives}
                        positions={tooltipPositions}
                    >
                        <ButtonLink
                            link='/objectives'
