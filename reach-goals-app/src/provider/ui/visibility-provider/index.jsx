...
export const VisibilityProvider = ({ children }) => {
    ...
    const toggleVisibility = useCallback(
        ({ class: classTarget, operator } = {}, event) => {
            ...
            setSafeVisibleElement((prev) => {
                ...
                const isVisible = isArrayClass
                    ? parameterTarget.class.some((c) => prev.includes(c))
                    : false
                return isVisible
                    ? removeVisibility(prev, parameterTarget)
                    : updateVisibility(prev, parameterTarget)
            })
        },
    ...
    const value = useMemo(
        () => ({ toggleVisibility, visibleElements }),
        [toggleVisibility, visibleElements]
    )
