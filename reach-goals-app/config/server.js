...
const { addTag, updateTag, getTag, deleteTag, getTagOnGoal, getTagNotGoal, getTagNotAssignment } = require('../api/tag/actions')
...
app.get('/api/tag/actions/:relationID', getTagNotGoal)
app.get('/api/tag/actions/:relationID', getTagNotAssignment)
